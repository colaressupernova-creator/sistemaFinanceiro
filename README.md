[index.html](https://github.com/user-attachments/files/25172648/index.html)
<!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Gestão Financeira Pro 2026</title>
...
<div class="topo-titulo">
    ...
    <div class="controles-topo">
        ...
        <button id="btnDarkMode" onclick="toggleDarkMode()">🌙</button>
    </div>
</div>
...
<div class="layout">
    ...
    <div class="principal">
        <div class="secao-form">
            <h2 id="formTitulo" style="margin: 0 0 1rem 0; font-size: 1rem;">Lançamento</h2>
            <div class="actions">
                <select id="tipo">
                ...
                <select id="categoria">
                    ...
                    <option value="Gastos Pessoais">💆‍♂️ Gastos Pessoais</option>
...
function mudarMes(){
    ...
    document.getElementById('tituloTopo').innerText = "GESTÃO FINANCEIRA — " + document.getElementById('mes').selectedOptions[0].text;
    cancelarEdicao();
    render();
}
...
function render(){
    ...
    dadosPorMes[mesAtual].receber.forEach((item, i) => {
        ...
        tRec.innerHTML += `<tr>
            ...
            <td><button class="btn-edit" onclick="prepararEdicao('receber',${i})">✎</button>
                <button class="btn-del" onclick="remover('receber',${i})">✕</button></td>
        </tr>`;
    });
    ...
    dadosPorMes[mesAtual].pagar.forEach((item, i) => {
        ...
        tPag.innerHTML += `<tr>
            ...
            <td><button class="btn-edit" onclick="prepararEdicao('pagar',${i})">✎</button>
                <button class="btn-del" onclick="remover('pagar',${i})">✕</button></td>
        </tr>`;
    });
...
function importarDados(event) {
    ...
    reader.onload = function(e) {
        ...
        } catch (err) { alert("Erro ao ler arquivo. Certifique-se que é o arquivo .json correto."); }
    };
